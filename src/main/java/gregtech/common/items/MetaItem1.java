...
public class MetaItem1 extends StandardMetaItem {
    ...
    public void registerSubItems() {
        ...
        FLUID_CELL = addItem(78, "fluid_cell").addComponents(new AdvancedFluidStats(1000, false, new FluidContainmentInfo.Builder().liquids().gases().temperature(1800).build()), new ItemFluidContainer());

        FLUID_CELL_UNIVERSAL = addItem(79, "fluid_cell.universal").addComponents(new AdvancedFluidStats(1000, true, new FluidContainmentInfo.Builder().liquids().gases().temperature(1800).build()), new ItemFluidContainer());
